  ...
  return (
    <section className="container py-8 md:py-10">
      <div className="flex flex-col items-center gap-12">
        <h2 className={`font-inter text-heading-xl text-gray-100`}>
          Quem utiliza, aprova!
        </h2>

        <div className="grid gap-8 md:grid-cols-2">
          {customerStory.map((custumerStory) => (
            <div
              key={custumerStory.author.name}
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <strong className="text-gray-200 text-sm">
                    {custumerStory.author.name}
                  </strong>
                  <span className="text-xs text-gray-300">
                    {custumerStory.author.role}
                  </span>
                </div>
              </div>
            </div>
